...
const SomeThing = () => {
    ...
    return (
        <div >
            <div className=''>
                <div className=' bg-cover bg-left-bottom pt-[40px] xl:pt-[120px] pb-[34px] bg-no-repeat' style={{ backgroundImage: 'url(/shape/Line5.png)' }}>

                    <h2 className='text-base font-bold md:heading text-center'>Are you Looking For Something Else?</h2>
