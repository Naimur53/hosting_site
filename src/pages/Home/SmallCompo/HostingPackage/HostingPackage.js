...
const HostingPackage = () => {
    ...
    return (
        <div style={{ backgroundImage: 'url(/shape/Line4.png)' }} className='min-h-screen relative bg-cover bg-no-repeat pb-10  bg-banner'>
            ...
            <div className="absolute z-10 left-1/2 top-[500px]">
