        ...
        <div>
            <div className=' bg-cover pb-[90px] bg-no-repeat overflow-hidden bg-[#EDF2F4]'>
                <div className="container h-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-[121px] h-full">
                        <div>
                            <div className='overflow-hidden bg-no-repeat bg-bottom flex justify-center items-center h-full  pt-[47px] bg-contain '  >
                                <div>

                                    <img className='mt-0 md:mt-[108px]  mb-[60px] -ro tate-12' src="/images/box4.png" alt="logo" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className='overflow-hidden bg-no-repeat bg-bottom flex justify-center items-center h-full  pt-[47px] bg-contain ' >
                                <div>
                                    ...
                                    <img className='mt-0 md:mt-[108px]  mb-[60px] -ro tate-12' src="/images/box3.png" alt="logo" />
                                </div>
                            </div>
                        </div>
