...
const EmailBanner = () => {
    return (
        <div>
            <div>
                <div style={{ backgroundImage: 'url(/shape/Line4.png)' }} className=' relative flex items-center bg-cover bg-no-repeat overflow-hidden pt-[167px]'>
                    <div className="container">
                        <div>
                            <h1 className='  text-lg md:text-2xl   text-center font-bold'> Business Email Hosting</h1>
                        ...
                        <div className="absolute  -translate-x-[200px] left-2/4 top-[300px]">
                            <div className='bg-[#07E1BA] absolute rotate-[14deg] blur-[100px] h-[150px] w-[70px] md:w-[640px] -translate-x-1/2'>

                            </div>
                            <div className='bg-[#0074FF] absolute rotate-[-4deg] blur-[120px] h-[150px]  w-[70px] md:w-[640px]'>
